...
#define MAX_OBJECTS_LIFE 100.f

#define MAX_BUILDING_COUNT 6
#define MAX_BUILDING_SIZE 120
#define MAX_BUILDING_LIFE 1000.f

#define MAX_BULLET_COUNT 120	//MAX_BUILDING_COUNT개의 건물이 나누어서 쏘니 (MAX_BULLET_COUNT/MAX_BUILDING_COUNT)발씩 쏘는 것이다.
#define MAX_BULLET_SIZE 5

#define MAX_ARROW_COUNT 1000	//MAX_OBJECTS_COUNT개의 캐릭이 나누어서 쏘니 (MAX_ARROW_COUNT/MAX_OBJECTS_COUNT)발씩 쏘는 것이다. 
